...
/**
 * Class WP_EXT_Feature_Post_Field
 */
class WP_EXT_Feature_Post_Field extends WP_EXT_Feature {
	...
	public function post_fields() {
		if ( function_exists( 'acf_add_local_field_group' ) ) {
			acf_add_local_field_group( [
				...
				'title'                 => esc_html__( 'Информация об особенности', 'wp-ext-' . $this->domain_ID ),
				'fields'                => [
					[
 ...
 *
 * @return WP_EXT_Feature_Post_Field
 */
function WP_EXT_Feature_Post_Field() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Feature_Post_Field;
	}
 ...
 */
add_action( 'plugins_loaded', [ WP_EXT_Feature_Post_Field(), 'run' ] );
