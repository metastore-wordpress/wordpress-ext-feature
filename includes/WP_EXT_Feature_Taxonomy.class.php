...
/**
 * Class WP_EXT_Feature_Taxonomy
 */
class WP_EXT_Feature_Taxonomy extends WP_EXT_Feature {
	...
	/**
	 * Taxonomy: `feature_meta`.
	 */
	public function taxonomy_meta() {
		$labels  = [
			'name'                       => _x( 'Feature Meta', 'Meta General Name', 'wp-ext-' . $this->domain_ID ),
 ...
 *
 * @return WP_EXT_Feature_Taxonomy
 */
function WP_EXT_Feature_Taxonomy() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Feature_Taxonomy;
	}
 ...
 */
add_action( 'plugins_loaded', [ WP_EXT_Feature_Taxonomy(), 'run' ] );
