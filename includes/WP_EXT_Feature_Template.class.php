...
/**
 * Class WP_EXT_Feature_Template
 */
class WP_EXT_Feature_Template extends WP_EXT_Feature {
 ...
 *
 * @return WP_EXT_Feature_Template
 */
function WP_EXT_Feature_Template() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Feature_Template;
	}
 ...
 */
add_action( 'plugins_loaded', [ WP_EXT_Feature_Template(), 'run' ] );
