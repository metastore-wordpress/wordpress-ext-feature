...
class WP_EXT_Feature {
	...
	public function __construct() {
		// Settings.
		$this->pt_ID      = 'feature';
		$this->archive_ID = 'features';
		$this->domain_ID  = 'feature';
		$this->cap_type   = [ 'pt_feature', 'pt_features' ];
 ...
 *
 * @return WP_EXT_Feature
 * ------------------------------------------------------------------------------------------------------------------ */

function WP_EXT_Feature() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Feature;
	}
...
add_action( 'plugins_loaded', [ WP_EXT_Feature(), 'run' ] );
