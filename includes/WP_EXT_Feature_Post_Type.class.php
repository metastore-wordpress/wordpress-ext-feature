...
/**
 * Class WP_EXT_Feature_Post_Type
 */
class WP_EXT_Feature_Post_Type extends WP_EXT_Feature {
	...
	public function post_type() {
		$labels  = [
			'name'                  => _x( 'Features', 'Feature General Name', 'wp-ext-' . $this->domain_ID ),
			'singular_name'         => _x( 'Feature', 'Feature Singular Name', 'wp-ext-' . $this->domain_ID ),
			'menu_name'             => __( 'Features', 'wp-ext-' . $this->domain_ID ),
			'name_admin_bar'        => __( 'Feature', 'wp-ext-' . $this->domain_ID ),
		...
		$args    = [
			'label'               => __( 'Feature', 'wp-ext-' . $this->domain_ID ),
			'description'         => __( 'Feature Description', 'wp-ext-' . $this->domain_ID ),
			'labels'              => $labels,
 ...
 *
 * @return WP_EXT_Feature_Post_Type
 */
function WP_EXT_Feature_Post_Type() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Feature_Post_Type;
	}
 ...
 */
add_action( 'plugins_loaded', [ WP_EXT_Feature_Post_Type(), 'run' ] );
