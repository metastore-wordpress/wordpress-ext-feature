...
/**
 * Class WP_EXT_Feature_Theme
 * ------------------------------------------------------------------------------------------------------------------ */

class WP_EXT_Feature_Theme extends WP_EXT_Feature {
 ...
 *
 * @return WP_EXT_Feature_Theme
 * ------------------------------------------------------------------------------------------------------------------ */

function WP_EXT_Feature_Theme() {
	static $object;

	if ( null == $object ) {
		$object = new WP_EXT_Feature_Theme;
	}
...
add_action( 'plugins_loaded', [ WP_EXT_Feature_Theme(), 'run' ] );
